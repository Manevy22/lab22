    ...
    public class Estudiantes2 {
        ...
        private static void mostrarEstudiantesmas28(Connection conexion) throws SQLException {
            ...
            while (resultado.next()) {
                ...
                String fechaNacimientoStr = resultado.getString("fecha_nacimiento");
                ...
                if (periodo.getYears() >=28){
                    ...
                    String legajo = resultado.getString("legajo");
                    String dni = resultado.getString("dni");
                    String fechaNacimientoo = resultado.getString("fecha_nacimiento");
                    String direccion = resultado.getString("direccion");
                    String telefono = resultado.getString("telefono");
                    String email = resultado.getString("email");
                    ...
                    // Imprime los datos del estudiante con tabulaciones para formatear como una tabla.
                    System.out.println(id + "\t" + nombre + "\t" + apellido + "\t" + legajo + "\t" + dni + "\t" +
                            fechaNacimientoo + "\t" + direccion + "\t" + telefono + "\t" + email);
                }}
